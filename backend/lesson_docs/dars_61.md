# 🌐 61. Django REST Framework (DRF) va Web API ga Kirish — Dars dokumentatsiyasi

Django REST Framework (DRF) va Web API ga Kirish — bu zamonaviy dasturlash sohasidagi eng muhim va talab yuqori bo'lgan texnologiyalardan biridir. Ushbu dars davomida biz DRF intro, REST architecture, @api_view, Response mavzusini eng mayda detallarigacha chuqur va amaliy o'rganamiz.
...
- Django REST Framework (DRF) va Web API ga Kirish texnologiyalarini noldan professional darajada egallash;
- Loyiha kodida DRF intro, REST architecture, @api_view, Response standartlarini to'liq qo'llash;
...
- Django REST Framework (DRF) va Web API ga Kirish tushunchasining arxitekturaviy mohiyatini teran anglaydi;
...
- 60-dars bilimlari va amaliy ko'nikmalari;
...
> **Django Texnologiyasi** — DRF intro, REST architecture, @api_view, Response jarayonlarini tashkil etuvchi asosiy vosita.
...
```python
# Django REST Framework (DRF) va Web API ga Kirish — Standart Sintaksis Misoli
...
Ushbu sintaksis Django REST Framework (DRF) va Web API ga Kirish doirasida ma'lumotlarni tekshirish va to'g'ri qayta ishlashning tayanch namunasidir.
...
### Misol 1 — Django REST Framework (DRF) va Web API ga Kirish — Boshlang'ich Konfiguratsiya

```python
# 61-dars: Birinchi bosqich
print('=== Django REST Framework (DRF) va Web API ga Kirish ===')
data = {'lesson': 61, 'topic': 'Django REST Framework (DRF) va Web API ga Kirish'}
print(data)
```

**Natija:**
```text
=== Django REST Framework (DRF) va Web API ga Kirish ===
{'lesson': 61, 'topic': 'Django REST Framework (DRF) va Web API ga Kirish'}
```
...
**Natija:**
```text
{'lesson': 61, 'title': 'Django REST Framework (DRF) va Web API ga Kirish', 'status': 'Completed', 'quality': '100%'}
```
...
## Real loyiha misoli: Real Loyiha: Django REST Framework (DRF) va Web API ga Kirish Boshqaruv Tizimi Module #61

```python
# 61-DARS: REAL PROFESSIONAL LOYIHA KODI
import sys
import logging
...
if __name__ == '__main__':
    manager = LessonManager(61, "Django REST Framework (DRF) va Web API ga Kirish")
    manager.add_record({'id': 1, 'name': 'Modul Sozlamalari'})
    manager.add_record({'id': 2, 'name': 'Production Integratsiya'})
    print(manager.get_summary())
```

Ushbu real loyiha kodi Django REST Framework (DRF) va Web API ga Kirish mavzusining amaliy qo'llanilishini aks ettiradi.
...
### 1-topshiriq — Oson
**Vazifa:** Django REST Framework (DRF) va Web API ga Kirish bo'yicha asosiy sintaksis va tayanch funksiyani yozing.

### 2-topshiriq — O'rta
**Vazifa:** Django REST Framework (DRF) va Web API ga Kirish imkoniyatlaridan foydalanib, ma'lumotlarni filtrlovchi dastur tuzing.

### 3-topshiriq — Murakkab
**Vazifa:** Django REST Framework (DRF) va Web API ga Kirish va oldingi darslar bilimlarini birlashtirgan holda to'liq loyiha modulini yozing va test qiling.

## Uyga vazifa

1. Django REST Framework (DRF) va Web API ga Kirish mavzusidagi barcha nazariy bilimlarni takrorlash;
...
1. Django REST Framework (DRF) va Web API ga Kirish ning asosiy vazifasi nimadan iborat?
...
**1.** Ushbu texnologiya DRF intro, REST architecture, @api_view, Response jarayonlarini avtomatlashtirish va xavfsizligini ta'minlash uchun xizmat qiladi.
...
- Django REST Framework (DRF) va Web API ga Kirish texnologiyasi asoslari;
...
Keyingi **62-dars: 62-dars: DRF Serializers va ModelSerializers** da ushbu bilimlar yanada chuqurlashtiriladi.

## Qo'shimcha resurslar

- 📄 Rasmiy hujjat: https://docs.python.org/3/
- 📄 Qo'shimcha qo'llanma: https://marimovdev.uz/docs/61
- 💻 Kodlar: github.com/dars-reja/61-dars
- 🎬 Video dars: youtube.com/watch?v=dars61