# 🔄 71. CI/CD (GitHub Actions) va Avtomatik Deploy — Dars dokumentatsiyasi

CI/CD (GitHub Actions) va Avtomatik Deploy — bu zamonaviy dasturlash sohasidagi eng muhim va talab yuqori bo'lgan texnologiyalardan biridir. Ushbu dars davomida biz GitHub Actions, .github/workflows/deploy.yml, SSH deploy mavzusini eng mayda detallarigacha chuqur va amaliy o'rganamiz.
...
- CI/CD (GitHub Actions) va Avtomatik Deploy texnologiyalarini noldan professional darajada egallash;
- Loyiha kodida GitHub Actions, .github/workflows/deploy.yml, SSH deploy standartlarini to'liq qo'llash;
...
- CI/CD (GitHub Actions) va Avtomatik Deploy tushunchasining arxitekturaviy mohiyatini teran anglaydi;
...
- 70-dars bilimlari va amaliy ko'nikmalari;
...
## CI/CD Texnologiyasi nima?

> **CI/CD Texnologiyasi** — GitHub Actions, .github/workflows/deploy.yml, SSH deploy jarayonlarini tashkil etuvchi asosiy vosita.
...
```python
# CI/CD (GitHub Actions) va Avtomatik Deploy — Standart Sintaksis Misoli
...
Ushbu sintaksis CI/CD (GitHub Actions) va Avtomatik Deploy doirasida ma'lumotlarni tekshirish va to'g'ri qayta ishlashning tayanch namunasidir.
...
### Misol 1 — CI/CD (GitHub Actions) va Avtomatik Deploy — Boshlang'ich Konfiguratsiya

```python
# 71-dars: Birinchi bosqich
print('=== CI/CD (GitHub Actions) va Avtomatik Deploy ===')
data = {'lesson': 71, 'topic': 'CI/CD (GitHub Actions) va Avtomatik Deploy'}
print(data)
```

**Natija:**
```text
=== CI/CD (GitHub Actions) va Avtomatik Deploy ===
{'lesson': 71, 'topic': 'CI/CD (GitHub Actions) va Avtomatik Deploy'}
```
...
def final_summary():
    return {
        'lesson': 71,
        'title': 'CI/CD (GitHub Actions) va Avtomatik Deploy',
        'status': 'Completed',
        'quality': '100%'
    }
print(final_summary())
...
**Natija:**
```text
{'lesson': 71, 'title': 'CI/CD (GitHub Actions) va Avtomatik Deploy', 'status': 'Completed', 'quality': '100%'}
```
...
## Real loyiha misoli: Real Loyiha: CI/CD (GitHub Actions) va Avtomatik Deploy Boshqaruv Tizimi Module #71

```python
# 71-DARS: REAL PROFESSIONAL LOYIHA KODI
import sys
import logging
...
if __name__ == '__main__':
    manager = LessonManager(71, "CI/CD (GitHub Actions) va Avtomatik Deploy")
    manager.add_record({'id': 1, 'name': 'Modul Sozlamalari'})
    manager.add_record({'id': 2, 'name': 'Production Integratsiya'})
    print(manager.get_summary())
```

Ushbu real loyiha kodi CI/CD (GitHub Actions) va Avtomatik Deploy mavzusining amaliy qo'llanilishini aks ettiradi.
...
### 1-topshiriq — Oson
**Vazifa:** CI/CD (GitHub Actions) va Avtomatik Deploy bo'yicha asosiy sintaksis va tayanch funksiyani yozing.

### 2-topshiriq — O'rta
**Vazifa:** CI/CD (GitHub Actions) va Avtomatik Deploy imkoniyatlaridan foydalanib, ma'lumotlarni filtrlovchi dastur tuzing.

### 3-topshiriq — Murakkab
**Vazifa:** CI/CD (GitHub Actions) va Avtomatik Deploy va oldingi darslar bilimlarini birlashtirgan holda to'liq loyiha modulini yozing va test qiling.

## Uyga vazifa

1. CI/CD (GitHub Actions) va Avtomatik Deploy mavzusidagi barcha nazariy bilimlarni takrorlash;
...
1. CI/CD (GitHub Actions) va Avtomatik Deploy ning asosiy vazifasi nimadan iborat?
...
**1.** Ushbu texnologiya GitHub Actions, .github/workflows/deploy.yml, SSH deploy jarayonlarini avtomatlashtirish va xavfsizligini ta'minlash uchun xizmat qiladi.
...
- CI/CD (GitHub Actions) va Avtomatik Deploy texnologiyasi asoslari;
...
Keyingi **72-dars: 72-dars: 6-Modul Yakuniy Imtihon va Bitiruv Loyihasi** da ushbu bilimlar yanada chuqurlashtiriladi.

## Qo'shimcha resurslar

- 📄 Rasmiy hujjat: https://docs.python.org/3/
- 📄 Qo'shimcha qo'llanma: https://marimovdev.uz/docs/71
- 💻 Kodlar: github.com/dars-reja/71-dars
- 🎬 Video dars: youtube.com/watch?v=dars71