# 🖼 56. Django Static Files & Media Fayllar bilan Ishlash — Dars dokumentatsiyasi

Django Static Files & Media Fayllar bilan Ishlash — bu zamonaviy dasturlash sohasidagi eng muhim va talab yuqori bo'lgan texnologiyalardan biridir. Ushbu dars davomida biz STATIC_URL, MEDIA_ROOT, {% load static %} mavzusini eng mayda detallarigacha chuqur va amaliy o'rganamiz.
...
- Django Static Files & Media Fayllar bilan Ishlash texnologiyalarini noldan professional darajada egallash;
- Loyiha kodida STATIC_URL, MEDIA_ROOT, {% load static %} standartlarini to'liq qo'llash;
...
- Django Static Files & Media Fayllar bilan Ishlash tushunchasining arxitekturaviy mohiyatini teran anglaydi;
...
- 55-dars bilimlari va amaliy ko'nikmalari;
...
> **Django Texnologiyasi** — STATIC_URL, MEDIA_ROOT, {% load static %} jarayonlarini tashkil etuvchi asosiy vosita.
...
```python
# Django Static Files & Media Fayllar bilan Ishlash — Standart Sintaksis Misoli
...
Ushbu sintaksis Django Static Files & Media Fayllar bilan Ishlash doirasida ma'lumotlarni tekshirish va to'g'ri qayta ishlashning tayanch namunasidir.
...
### Misol 1 — Django Static Files & Media Fayllar bilan Ishlash — Boshlang'ich Konfiguratsiya

```python
# 56-dars: Birinchi bosqich
print('=== Django Static Files & Media Fayllar bilan Ishlash ===')
data = {'lesson': 56, 'topic': 'Django Static Files & Media Fayllar bilan Ishlash'}
print(data)
```

**Natija:**
```text
=== Django Static Files & Media Fayllar bilan Ishlash ===
{'lesson': 56, 'topic': 'Django Static Files & Media Fayllar bilan Ishlash'}
```
...
def final_summary():
    return {
        'lesson': 56,
        'title': 'Django Static Files & Media Fayllar bilan Ishlash',
        'status': 'Completed',
        'quality': '100%'
    }
print(final_summary())
...
**Natija:**
```text
{'lesson': 56, 'title': 'Django Static Files & Media Fayllar bilan Ishlash', 'status': 'Completed', 'quality': '100%'}
```
...
## Real loyiha misoli: Real Loyiha: Django Static Files & Media Fayllar bilan Ishlash Boshqaruv Tizimi Module #56

```python
# 56-DARS: REAL PROFESSIONAL LOYIHA KODI
import sys
import logging
...
if __name__ == '__main__':
    manager = LessonManager(56, "Django Static Files & Media Fayllar bilan Ishlash")
    manager.add_record({'id': 1, 'name': 'Modul Sozlamalari'})
    manager.add_record({'id': 2, 'name': 'Production Integratsiya'})
    print(manager.get_summary())
```

Ushbu real loyiha kodi Django Static Files & Media Fayllar bilan Ishlash mavzusining amaliy qo'llanilishini aks ettiradi.
...
### 1-topshiriq — Oson
**Vazifa:** Django Static Files & Media Fayllar bilan Ishlash bo'yicha asosiy sintaksis va tayanch funksiyani yozing.

### 2-topshiriq — O'rta
**Vazifa:** Django Static Files & Media Fayllar bilan Ishlash imkoniyatlaridan foydalanib, ma'lumotlarni filtrlovchi dastur tuzing.

### 3-topshiriq — Murakkab
**Vazifa:** Django Static Files & Media Fayllar bilan Ishlash va oldingi darslar bilimlarini birlashtirgan holda to'liq loyiha modulini yozing va test qiling.

## Uyga vazifa

1. Django Static Files & Media Fayllar bilan Ishlash mavzusidagi barcha nazariy bilimlarni takrorlash;
...
1. Django Static Files & Media Fayllar bilan Ishlash ning asosiy vazifasi nimadan iborat?
...
**1.** Ushbu texnologiya STATIC_URL, MEDIA_ROOT, {% load static %} jarayonlarini avtomatlashtirish va xavfsizligini ta'minlash uchun xizmat qiladi.
...
- Django Static Files & Media Fayllar bilan Ishlash texnologiyasi asoslari;
...
Keyingi **57-dars: 57-dars: Django Forms, CSRF Token va Validatsiya** da ushbu bilimlar yanada chuqurlashtiriladi.

## Qo'shimcha resurslar

- 📄 Rasmiy hujjat: https://docs.python.org/3/
- 📄 Qo'shimcha qo'llanma: https://marimovdev.uz/docs/56
- 💻 Kodlar: github.com/dars-reja/56-dars
- 🎬 Video dars: youtube.com/watch?v=dars56